 ...
 * @author Matt Champion 21/01/2017
 */
public final class CompositeListener implements SpeckyListener {
    private final Collection<SpeckyListener> delegates;

    /**
     * Constructor.
     */
    public CompositeListener(Collection<SpeckyListener> delegates) {
